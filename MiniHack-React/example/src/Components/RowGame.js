    ...
    render() {
        return (
            <tr>
                ...
                <td >
                    <input name="round1" className="input" type="text" onChange={e => this.handleChangeText1(e.target.value)} />
                </td>
                <td >
                    <input name="round2" className="input" type="text" onChange={e => this.handleChangeText2(e.target.value)} />
                </td>
                <td>
                    <input name="round3" className="input" type="text" onChange={e => this.handleChangeText3(e.target.value)} />
                </td>
                <td>
                    <input name="round4" className="input" type="text" onChange={e => this.handleChangeText4(e.target.value)} />
                </td>
            </tr>
        )
    }
